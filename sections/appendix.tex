...
Everything we know about a patient (the patient `features') may shift
the predicted probability of receiving thrombolysis. Each patient
feature will have its own Shap value depending on the value of that
feature. \emph{Stroke severity}, for example, may be in the range 0-42,
and the Shap value will depend on the value of the feature. The final
predicted probability of receiving thrombolysis will be the model
baseline prediction (the predicted probability of receiving thrombolysis
before anything is known about a patient) and the sum of the influences
